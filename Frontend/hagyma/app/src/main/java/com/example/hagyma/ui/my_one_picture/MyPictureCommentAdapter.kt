...
class MyPictureCommentAdapter(private val context: Context?, private val myOnePictureViewModel: MyOnePictureViewModel?) :
    ...
    override fun onBindViewHolder(holder: SearchedPictureItemViewHolder, position: Int) {
        ...
        holder.binding.btnDeleteComment.setOnClickListener {
            CoroutineScope(Dispatchers.IO).launch {
                myOnePictureViewModel?.deleteComment(currListItem.uuid)
            }
