...
public class CaffControllerIntegrationTest : IClassFixture<TestingWebAppFactory>
{
    ...
    public async Task AddComment_NotExistent()
    {
        ...
        var response = await Helper.PostWithAuth(_client, "/api/Caff/addComment?imageId=NotExistentID", token,
    ...
    {
        var token = await Helper.GetAccessToken(_client);
        var response = await Helper.PostWithAuth(_client, "/api/Caff/addComment?imageId=ImageID", token,
            new CommentRequest {Content = "Content"});
    ...
    {
        var response = await Helper.PostWithoutAuth(_client, "/api/Caff/addComment?imageId=ImageID",
            new CommentRequest {Content = "Content"});
