...
namespace Backend.Migrations
{
    ...
    [Migration("20221114140709_addPurchased")]
            ...
            modelBuilder.Entity("Backend.Dal.Entities.DbComment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "CommentID",
                            CreatedDate = new DateTime(2022, 11, 14, 15, 7, 9, 133, DateTimeKind.Local).AddTicks(7221),
                            ImageId = "IMAGEID",
                            Text = "Test comment",
                            UserId = "ID"
                        });
            ...
            modelBuilder.Entity("Backend.Dal.Entities.DbImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title = "Title",
                            UploadTime = new DateTime(2022, 11, 14, 15, 7, 9, 133, DateTimeKind.Local).AddTicks(3028)
                        });
                });
            ...
            modelBuilder.Entity("Backend.Dal.Entities.DbUserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ID",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ff8f5270-792a-4e57-b67c-1b6364fe3ac6",
                            Email = "dummy@dummy.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            Role = 0,
                            SecurityStamp = "4a8ea71d-d210-4bbd-8e63-65d13b3d801b",
